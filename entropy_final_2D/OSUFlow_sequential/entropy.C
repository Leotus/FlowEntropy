							  ...
							  int* donotchange)
{
	...
	memset(kx, 0, sizeof(kx[0]) * grid_res[0]*grid_res[1]);
	memset(ky, 0, sizeof(ky[0]) * grid_res[0]*grid_res[1]);
	memset(b, 0, sizeof(b[0]) * grid_res[0]*grid_res[1]);
	memset(c1, 0, sizeof(c1[0]) * grid_res[0]*grid_res[1]);
	memset(c2, 0, sizeof(c2[0]) * grid_res[0]*grid_res[1]);
	...
	#else	// MOD-BY-LEETEN 12/07/2009-TO:
	memcpy(tmp_new_vectors, new_vectors, sizeof(tmp_new_vectors[0])*grid_res[0]*grid_res[1]*3);
	#endif	// MOD-BY-LEETEN 12/07/2009-END
