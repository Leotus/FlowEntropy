...
{ 
#line 99 "e:/project/FlowEntropy/FlowFusion/FlowFusion_test/FlowFusion.cu"
auto int iVoxelX = (blockIdx.x * blockDim.x + threadIdx.x); 
#line 108 "e:/project/FlowEntropy/FlowFusion/FlowFusion_test/FlowFusion.cu"
...
#line 115 "e:/project/FlowEntropy/FlowFusion/FlowFusion_test/FlowFusion.cu"
auto float fAttenuationDividedBy6 = (fAttenuation / (6.0F)); 
#line 204 "e:/project/FlowEntropy/FlowFusion/FlowFusion_test/FlowFusion.cu"
auto float4 f4Value; 
auto float4 f4PX; 
auto float4 f4NX; 
auto float4 f4PY; 
...
auto float4 f4PZ; 
auto float4 f4NZ; 
#line 219 "e:/project/FlowEntropy/FlowFusion/FlowFusion_test/FlowFusion.cu"
...
#line 225 "e:/project/FlowEntropy/FlowFusion/FlowFusion_test/FlowFusion.cu"
...
#line 242 "e:/project/FlowEntropy/FlowFusion/FlowFusion_test/FlowFusion.cu"
...
#line 246 "e:/project/FlowEntropy/FlowFusion/FlowFusion_test/FlowFusion.cu"
for (int z = iBeginZ; z < iEndZ; ((z++), (f4NZ = f4Value)), (f4Value = f4PZ)) 
{ 

auto float4 f4WeightOffset = tex3D(t3dWeightOffset, iVoxelX, iVoxelY, z); 
#line 261 "e:/project/FlowEntropy/FlowFusion/FlowFusion_test/FlowFusion.cu"
...
#line 305 "e:/project/FlowEntropy/FlowFusion/FlowFusion_test/FlowFusion.cu"
f4PZ = tex2D(t2dSrc, iVoxelX, iVoxelY + min(z + 1, iVolumeDepth - 1) * iVolumeHeight); 
#line 316 "e:/project/FlowEntropy/FlowFusion/FlowFusion_test/FlowFusion.cu"
auto float4 f4Result; 

if ((((((((0.0F) != (f4Value.w)) || (z == 0)) || (z == (iVolumeDepth - 1))) || (iVoxelX == 0)) || (iVoxelX == (iVolumeWidth - 1))) || (iVoxelY == 0)) || (iVoxelY == (iVolumeHeight - 1))) { 



f4Result = f4Value; } else { 

f4Result = make_float4((f4WeightOffset.w * f4Value.x + ((((((f4PX.x + f4NX.x) + f4PY.x) + f4NY.x) + f4PZ.x) + f4NZ.x) - (6.0F) * f4Value.x) * fAttenuationDividedBy6) + f4WeightOffset.x, (f4WeightOffset.w * f4Value.y + ((((((f4PX.y + f4NX.y) + f4PY.y) + f4NY.y) + f4PZ.y) + f4NZ.y) - (6.0F) * f4Value.y) * fAttenuationDividedBy6) + f4WeightOffset.y, (f4WeightOffset.w * f4Value.z + ((((((f4PX.z + f4NX.z) + f4PY.z) + f4NY.z) + f4PZ.z) + f4NZ.z) - (6.0F) * f4Value.z) * fAttenuationDividedBy6) + f4WeightOffset.z, 0); }  
#line 332 "e:/project/FlowEntropy/FlowFusion/FlowFusion_test/FlowFusion.cu"
...
#line 360 "e:/project/FlowEntropy/FlowFusion/FlowFusion_test/FlowFusion.cu"
} 
#endif
