...
#define NR_OF_BINS		32	// 60		// 60
#define	KERNEL_SIZE		4	// 8		// 8

#define	IMPORTANCE_SAMPLING_CHAIN_RULE			0x01
#define	IMPORTANCE_SAMPLING_REJECTION_METHOD	0x02

#define	IMPORTANCE_SAMPLING		IMPORTANCE_SAMPLING_CHAIN_RULE	// IMPORTANCE_SAMPLING_CHAIN_RULE	// IMPORTANCE_SAMPLING_CHAIN_RULE		// IMPORTANCE_SAMPLING_CHAIN_RULE	// IMPORTANCE_SAMPLING_REJECTION_METHOD
...
#define PRUNING_MODE	PRUNING_MODE_KEEP_WHEN_DISTANT // 	// PRUNING_MODE_COND_ENTROPY	//	PRUNING_MODE_KEEP_WHEN_DISTANT	// PRUNING_MODE_COND_ENTROPY
...
#define	LOCAL_MAX_THRESHOLD		0.5f	// 0.7f
...
#define KERNEL_SHAPE	KERNEL_SHAPE_CIRCLE	
